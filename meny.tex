...
\usepackage{luacode}
\usepackage[top=0.5in, bottom=0.5in, left=0.3in, right=0.28in]{geometry}
...
\pgfpageslogicalpageoptions{1}{scale=0.97}
\pgfpageslogicalpageoptions{2}{scale=0.97}
...
\node[anchor=north west,xshift=.3in,yshift=0pt]{\includesvg{logo}};
\end{tikzpicture}
